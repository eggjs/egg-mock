...
module.exports = function(options) {
  ...
  app = new Proxy(app, {
    ...
    defineProperty(target, prop, descriptor) {
      ...
      Object.defineProperty(target.app, prop, descriptor);
      return true;
    },
